...
export const CARREGAR_POSTAGENS_POR_CATEGORIA =
...
export function callCarregarCategorias() {
  return dispatch => {
    API.getCategories().then(response =>
      dispatch(carregarCategorias(response))
    );
  };
}
...
export function callCarregarPostagens() {
  return dispatch => {
    API.getPosts().then(response => dispatch(carregarPostagens(response)));
  };
}

export function callCarregarPostagensPorCategoria(categoria) {
  return dispatch => {
    API.getPostsByCategory(categoria).then(response =>
      dispatch(carregarPostagensPorCategoria(categoria, response))
    );
  };
}
...
export function callCarregarPostagem(id) {
  return dispatch => {
    API.getPost(id).then(response => dispatch(carregarPostagem(response)));
  };
}

export function callCriarPostagem(postagem) {
  return dispatch => {
    API.createPost(postagem).then(response =>
      dispatch(carregarPostagem(response))
    );
  };
}
...
export function callEditarPostagem(postagem) {
  return dispatch => {
    API.editPost(postagem).then(response =>
      dispatch(carregarPostagem(response))
    );
  };
}
...
export function callExcluirPostagem(id) {
  return dispatch => {
    API.deletePost(id).then(() => dispatch(excluirPostagem(id)));
  };
}
...
export function callCarregarComentarios(id) {
  return dispatch => {
    API.getComments(id).then(response =>
      dispatch(carregarComentarios(id, response))
    );
  };
}
...
export function callCarregarComentario(id) {
  return dispatch => {
    API.getComment(id).then(response =>
      dispatch(carregarComentario(id, response))
    );
  };
}
...
export function callEditarComentario(comentario) {
  return dispatch => {
    API.editComment(comentario).then(response =>
      dispatch(carregarComentario(comentario.id, response))
    );
  };
}
...
export function callExcluirComentario(id) {
  return dispatch => {
    API.deleteComment(id).then(() => dispatch(excluirComentario(id)));
  };
}
